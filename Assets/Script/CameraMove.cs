...
public class CameraMove : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        //->화면 이동은 어차피 x축만 움직여서 y값도 제한함 임 준
        main_camera.position = new Vector3(target.position.x + 6.5f, main_camera.transform.position.y, main_camera.transform.position.z);
    }
}
